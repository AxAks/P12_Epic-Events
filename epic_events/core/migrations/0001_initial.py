    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(help_text='The department this user belongs to. An Employee will get all custom_permissions granted to  their department.', related_name='user_department', related_query_name='employee', to='core.department', verbose_name='departments')),
