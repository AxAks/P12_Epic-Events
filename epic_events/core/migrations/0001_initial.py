    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(help_text='The department this user belongs to. An Employee will get all permissions granted to  their department.', related_name='user_set', related_query_name='user', to='auth.department', verbose_name='department')),
